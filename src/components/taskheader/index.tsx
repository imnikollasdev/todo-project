...
const TaskTitle = ({ tasks, handlerfinalize, handlerdelete }: TaskTitleProps) => {
    ...
    return (
        <>
            <C.Container>
                <C.Left>
                    <C.Title color = "purple">Tarefas criadas</C.Title>
                ...
                (
                    <>
                        ...
                        <C.Align>
                            ...
                            <C.TextBold >Você não tem tarefas criadas</C.TextBold>
                            <C.TextSemiBold>Crie tarefas e organize suas obrigações</C.TextSemiBold>
                        </C.Align>
                    </>
                )
                : (
